...
public interface DoctorAdviceDao
{
     ...
     * @return
     */
    List<DoctorAdvice> qryListBeanByMap(@Param("qry")
    Map<String, Object> map, @Param("paging") JqueryStylePaging jquryStylePaging);
     ...
     * @return
     */
    DoctorAdvice getYzByCondition(@Param("qry")
    Map<String, Object> map);
