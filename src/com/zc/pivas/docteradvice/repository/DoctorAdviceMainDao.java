...
public interface DoctorAdviceMainDao
{
     ...
     * @return
     */
    List<DoctorAdviceMain> qryListBeanByMap(@Param("qry")
     ...
     * @return
     */
    List<PrescriptionBLabel> qryYdMoreByPidsj(@Param("pidsj")
    String pidsj);
     ...
     * @return
     */
    List<DoctorAdviceGroupBean> groupByMap(@Param("qry")
    Map<String, Object> map);
     ...
     * @param pidsjN
     */
    void deleteYDMainByPidsjN(@Param("pidsjN")
    List<String> pidsjN);
     ...
     * @param pidsjN
     */
    void deleteYDByPidsjN(@Param("pidsjN")
    List<String> pidsjN);
     ...
     * @param pidsjN
     */
    void deletePQByPidsjN(@Param("pidsjN")
    List<String> pidsjN);
     ...
     * @return
     */
    List<Map<String, Object>> groupNumByInpArea(@Param("qry")
    Map<String, Object> map);
     ...
     * @return
     */
    DoctorAdviceMain getYzByCondition(@Param("qry")
    Map<String, Object> map);
     ...
     * @return
     */
    List<Frequency> qryBatchRule(@Param("qry")
    Map<String, Object> map);
     ...
     * @return
     */
    List<GeneralRule> qryGeneralRule(@Param("qry")
    Map<String, Object> map);
     ...
     * @return
     */
    List<Map<String, Object>> qryPatListByYZ(@Param("qry")
    Map<String, Object> map, @Param("paging")
    JqueryStylePaging jquryStylePaging);
     ...
     * @return
     */
    Integer qryPatListSize(@Param("qry")
    Map<String, Object> map);
     ...
     * @return
     */
    Integer updateYZAutoCheckN(@Param("map")
    Map<String, Object> map);
     ...
     * @return
     */
    Integer updateYZMainAutoCheckN(@Param("map")
    Map<String, Object> map);
     ...
     * @return
     */
    List<DoctorAdviceMainBean> qryListWithYZByMap(@Param("qry")
    Map<String, Object> map);
     ...
     * @return
     */
    Integer resetYZCheckStatus(@Param("qry")
    Map<String, Object> map);
     ...
     * @return
     */
    List<DoctorAdviceAreaPat> groupByAreaPat(@Param("map")
    Map<String, Object> map);
