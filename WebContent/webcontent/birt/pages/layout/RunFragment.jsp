...
<HTML lang="<%= attributeBean.getLanguage() %>">
	<HEAD>
		...
		<style type="text/css">
				#__BIRT_ROOT table{width: 100% !important;}
				.static-config .style_3>td,.static-config .style_2>td,.static-config .style_9>th{
					padding:10px 10px;
					vertical-align: middle;
				}
				.static-config  .style_25{
					padding-top:0px;
				}
				.static-config .style_22{
					padding-top:0px;
				}
				.style_9{
					vertical-align: middle;
				}
			.static-config .style_2 .style_3{
				background:rgba(64, 84, 179, 0.77);
			}
			.static-config .style_5{
					color:#000;
				    border-right:1px  solid #c0c3c7
				}
				.static-config .style_6,.static-config .style_7{
					color:#000;
				}
			.static-config .style_20,
			.static-config .style_12,
			.static-config .style_11,
			.static-config .style_14,
			.static-config .style_19,
			.static-config .style_18,
			.static-config .style_16,
			.static-config .style_15,
			.static-config .style_16,
			.static-config .style_10,
			.static-config th.style_9
			{
				padding: 5px;
			}
				.static-config th.style_9{
			...
			.style_8 tr:first-child{
				vertical-align: middle;
			}
				.style_8 tr:first-child td{
					width:100px;
					/*border:1px solid #ddd;*/
				}
				.style_8 tr:first-child td:last-child{
					/*border-right:0 none;*/
				}
				.style_8 .style_16,
				.style_8 .style_18,
				...
				.style_8 tr:first-child td .style_24{
					padding-top:0px;
				}
		</style>
	</HEAD>
	...
	<BODY CLASS="BirtViewer_Body"  ONLOAD="javascript:init( );" SCROLL="no" LEFTMARGIN='0px' 
		...
		<!-- Header section -->
		<TABLE ID='layout' class="static-config" CELLSPACING='0' CELLPADDING='0' STYLE='width:100%;height:100%'>
		<%
			if ( fragment != null )
			{
