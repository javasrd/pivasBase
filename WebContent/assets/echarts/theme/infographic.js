var eTheme_infographic = {
    // 默认色板
    color: [
		'#6495ED','#DC143C','#48D1CC',
		'#586CA6','#8A2BE2','#DEB887',
		'#008B8B','#006400','#8B0000',
		'#2F4F4F','#DAA520','#D87093',
		'#9ACD32','#008080','#B8860B',
		'#D19275','#FF4500','#00008B',
		'#FFFF00'
    ],

    // 图表标题
    title: {
        itemGap: 8,//主副标题纵向间隔，单位px，默认为10
        textStyle: {
            fontWeight: 'normal',
