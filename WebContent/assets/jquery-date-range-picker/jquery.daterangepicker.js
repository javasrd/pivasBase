...
}(function ($, moment)
{
	...
	$.fn.dateRangePicker = function(opt)
	{
		...
		{	
            ...
            var	startDate = new Date(f.getFullYear(),f.getMonth(),f.getDate() - number + 1),
            endDate = new Date(f.getFullYear(),f.getMonth(),f.getDate() - number + 7);
            
            startDate = $.datepicker.formatDate("yy-mm-dd", startDate),
            endDate = $.datepicker.formatDate("yy-mm-dd", endDate);
		
			var __default_string = opt.getValue.call(selfDom)==''?startDate+opt.separator+endDate:opt.getValue.call(selfDom);
