...
<head>
    ...
    function initDatatable() {
        datatable = $('.datatable').DataTable({
            ...
            "ajax": {
                "url": "${pageContext.request.contextPath}/dw/dwList",
                "type": "post",
                "data": function (d) {
                    var params = [];
                    if (qryParam) {
	...
	$(function() {
        ...
        $("#synDataDicBtn").bind("click", function () {
            layer.confirm('<spring:message code="common.startSynTask"/>', {
                ...
                $.ajax({
                    type: 'POST',
                    url: '${pageContext.request.contextPath}/dw/synDw',
                    dataType: 'json',
                    cache: false,
                    data: [],
...
<div class="main-div" style="width:100%">
	...
	<div data-qryMethod funname="qryList" class="ui-search-header ui-search-box" id="qryView-div" style="display: inline; ">
		...
		<input name="codes" placeholder="编码" size="8" data-cnd="true">&nbsp;&nbsp;
		...
		<shiro:hasPermission name="PIVAS_BTN_254">
    ...
    <table class="table datatable ui-data-table display dataTable no-footer">
        <thead>
        <tr>
            <th><spring:message code="pivas.drugway.id"/></th>
            <th><spring:message code="pivas.drugway.code"/></th>
            <th><spring:message code="pivas.drugway.name"/></th>
        </tr>
        </thead>
    </table>
</div>
