		...
		<script type="text/javascript" >
            ...
            $(document).ready(function(){
            	...
            	$("#btAddM").click(function(){
            		var rows2 = tabGrid.selectedValsByName('name');
            		//$.alert("你选择的内容是："+rows2);
            		//$.alert("你选择的内容是："+rows2,{"cancleShow": true});
            		$.alert("你选择的内容是："+rows2,{
            			"cancleShow": true,
            			"cancle": function(){
            				alert("你点击了取消");
            ...
            function qryList(page){
            	var params = {"qryStr":$("#qryStr").val(),"aaa":"123"};
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" class="btn btn-primary" id="btCancel" data-dismiss="modal">取消</a>
                </div>
            </div>
        </div>
    </div>
